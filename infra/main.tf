locals {
  ...
  providerAlias  = var.hub_subscription_id != "" ? "azurerm.hub" : "azurerm"
}
...
module "logging" {
  ...
  tags                             = local.tags
  skuName                          = "PerGB2018"
  resourceGroupName                = var.hub_logging_rg
  is_secure_mode                   = var.is_secure_mode
  use_existing                     = var.use_existing_logging
  existing_applicationInsightsName = var.applicationInsightsName
  existing_logAnalyticsName        = var.logAnalyticsName
}
...
module "kvModule" {
  ...
  tags                    = local.tags
  is_secure_mode          = var.is_secure_mode
  privateEndpointName     = "s-pe-kv-infoassist"
  privateEndpointNicName  = "s-nic-pe-kv-infoassist"
  privateEndpointSubnetId = "/subscriptions/cf67bcb9-7f11-4baa-af5f-88e772ea7ac8/resourceGroups/s-infoassist-dev/providers/Microsoft.Network/virtualNetworks/s-vnet-infoassist-dev/subnets/s-snet-services"
...
module "storage" {
  ...
  publicNetworkAccess   = var.is_secure_mode ? false : true
  resourceGroupName     = data.azurerm_resource_group.rg.name
  ...
  is_secure_mode              = var.is_secure_mode
  blobPrivateEndpointName     = "s-pe-sblob-infoassist"
  blobPrivateEndpointNicName  = "s-nic-pe-sblob-infoassist"
  queuePrivateEndpointName    = "s-pe-squeue-infoassist"
  queuePrivateEndpointNicName = "s-nic-pe-squeue-infoassist"
  privateEndpointSubnetId     = "/subscriptions/cf67bcb9-7f11-4baa-af5f-88e772ea7ac8/resourceGroups/s-infoassist-dev/providers/Microsoft.Network/virtualNetworks/s-vnet-infoassist-dev/subnets/s-snet-services"
}
